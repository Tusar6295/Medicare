...
public class SlotTimeMapper {
    ...
    public SlotTimeMapper() {
        // Populate the mappings for all 24 slots
        populateMappings();
    }

    private void populateMappings() {
        // Hardcode the mappings for all 24 slots
    ...
    public int getSlotFromTime(String time) {
        ...
        return slot != null ? slot : -1; // Return -1 if time not found
    }
